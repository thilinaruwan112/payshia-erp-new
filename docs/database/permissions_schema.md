...
**Example Data:**
```sql
-- Assuming 'products' page has ID=3 and actions 'read' and 'process' have IDs 1 and 2
INSERT INTO permissions (page_id, action_id) VALUES
(3, 1), -- products:read
(3, 2); -- products:process
```
---
