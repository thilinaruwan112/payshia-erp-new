...
import { orders, products, invoices, receipts } from '@/lib/data';
...
export default function SalesDashboardPage() {
  ...
  const salesStats = useMemo(() => {
    ...
    const totalRevenue = relevantOrders.reduce((acc, order) => acc + order.total, 0);
    ...
    <div className="flex flex-col gap-6">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
            <Card>
                ...
                <CardContent>
                    <div className="text-2xl font-bold">{currencySymbol}{salesStats.totalRevenue.toFixed(2)}</div>
             ...
             <Card>
                ...
                <CardContent>
                    <div className="text-2xl font-bold">{currencySymbol}{salesStats.avgOrderValue.toFixed(2)}</div>
