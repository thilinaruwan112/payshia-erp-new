...
export default function ItemWiseSalesReportPage() {
    ...
    const handleViewReport = useCallback(async () => {
        ...
        try {
            ...
            const url = `${process.env.NEXT_PUBLIC_API_BASE_URL}/reports/sales-item-wise?${params.toString()}`;
    ...
    return (
        <div className="space-y-6">
             <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                 <div>
                    <h1 className="text-3xl font-bold tracking-tight">Item Wise Sales Report</h1>
                    <p className="text-muted-foreground">Analyze sales performance for each item.</p>
                 </div>
