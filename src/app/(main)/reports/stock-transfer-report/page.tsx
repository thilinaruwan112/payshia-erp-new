...
export default function StockTransferReportPage() {
    ...
    const handleViewReport = useCallback(async () => {
        ...
        try {
            ...
            const url = `${process.env.NEXT_PUBLIC_API_BASE_URL}/reports/stock-transfer?${params.toString()}`;
    ...
    const handlePrint = () => {
        ...
        const params = new URLSearchParams({
            ...
            ...(filterValues['fromLocation'] && filterValues['fromLocation'] !== 'all' && { from_location: filterValues['fromLocation'] }),
            ...(filterValues['toLocation'] && filterValues['toLocation'] !== 'all' && { to_location: filterValues['toLocation'] }),
        });
        const url = `/reports-print/stock-transfer-report/print?${params.toString()}`;
    ...
    return (
        <div className="space-y-6">
             <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                 <div>
                    <h1 className="text-3xl font-bold tracking-tight">Stock Transfer Report</h1>
                    <p className="text-muted-foreground">Track movement of stock between locations.</p>
                 </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 items-end">
                <div className="space-y-1.5">
                 ...
                 <div className="space-y-1.5">
                    ...
                    <Combobox options={locationOptions} value={filterValues['fromLocation'] || ''} onChange={(value) => handleFilterChange('fromLocation', value)} placeholder="Select source..." notFoundText="No locations found." />
                </div>
                <div className="space-y-1.5">
                    <Label>To Location</Label>
                    <Combobox options={locationOptions} value={filterValues['toLocation'] || ''} onChange={(value) => handleFilterChange('toLocation', value)} placeholder="Select destination..." notFoundText="No locations found." />
                </div>
