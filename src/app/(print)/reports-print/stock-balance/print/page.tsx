            ...
            <table className="w-full text-left border-collapse">
                <thead>
                    <tr className="bg-[#3B5998] text-white">
                        ...
                        <th className="p-2 border border-gray-300 text-right">Sale Price</th>
                ...
                <tbody>
                    {items.map((item) => (
                        <tr key={item.product_variant_id} className="border-b">
                            ...
                            <td className="p-2 border border-gray-300 text-right font-mono">{currencySymbol}{parseFloat(item.sale_price).toFixed(2)}</td>
                            <td className="p-2 border border-gray-300 text-right font-mono">{currencySymbol}{parseFloat(item.cost_price).toFixed(2)}</td>
