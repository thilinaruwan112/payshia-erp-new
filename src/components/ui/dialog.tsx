  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        "sm:left-[50%] sm:top-[50%] sm:h-[70vh] sm:w-[70vw] sm:translate-x-[-50%] sm:translate-y-[-50%] sm:rounded-lg sm:data-[state=closed]:slide-out-to-top-[48%] sm:data-[state=open]:slide-in-from-top-[48%]", // Desktop styles
        className
      )}
      {...props}
    >
